...
console.log(numbers.filter(filter_1));

/*3*/

console.log(
  people.find(function n(el) {
    return el.age < 18;
  })
);
...
console.log(
  numbers.reduce(function sum(num, acc) {
    acc = acc + num;
    return acc;
  }, 0)
);
...
console.log(
  people.findIndex(function filter_2(el) {
